...
int main() {
    ...
    // ================================================
    Mat save_original_bgr, save_result_bgr;
    cvtColor(image_rgb, save_original_bgr, COLOR_RGB2BGR);
    cvtColor(result, save_result_bgr, COLOR_RGB2BGR);
    imwrite("outputs_tp3/01_original.png", save_original_bgr);
    imwrite("outputs_tp3/02_color_mask.png", color_mask);
    imwrite("outputs_tp3/03_edges_color_mask.png", combined);
    imwrite("outputs_tp3/04_birds_eye_view.png", warped);
    imwrite("outputs_tp3/05_detected_lanes_bird_view.png", lane_warp);
    imwrite("outputs_tp3/06_final_result.png", save_result_bgr);
    cout << "Images sauvegardees dans outputs_tp3" << endl;
    return 0;
    // 8. Display results
    // ================================================
